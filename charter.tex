...
\director{Ing. Juan Manuel Cruz - A Definir}
...
\fechaFINALTrabajo{31 de Marzo de 2025}			%Fecha de defensa pública del trabajo final
...
Por medio de la presente se acuerda con el \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'' y consistirá en la implementación de un prototipo experimental de un drone de bajo coste. El trabajo tendrá un presupuesto preliminar estimado de 640 horas y un costo estimado de \$ 300.000, con fecha de inicio el \fechaInicioName\hspace{1px} y fecha de presentación pública el \fechaFinalName.
